...
async function waitForLoggedIn(context, timeoutMs) {
    ...
    throw new Error('Login timeout: still looks like you are not authenticated (expected /api/recent-searches to succeed).');
}
